...
- mixed #2: **two P1 completion routes, neither ready**. (1) Bopp & Gottsberger 2004 (*Silene × Hadena*) directly measures same-season flowering and moth oviposition but lacks a final plant reproductive surface in the article; Bopp 2003 is the completion target. (2) Rentería & Cantú 2003 (*Yucca filifera × Tegeticula yuccasella*) directly measures the same-season moth window and mature viable/damaged seeds, but final seed records are pooled across flowering cohorts, so the March-high versus May-zero-moth contrast cannot yet be linked to final reproduction. Kawashima et al. 2026 (*Sambucus × Heterhelus*) is no longer P1 after supporting-information audit: reproductive datasets are detailed, but the visitor supplement reports observation dates/durations rather than a quantitative Heterhelus activity series, so the strict timing exposure cannot be constructed;
