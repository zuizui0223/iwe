...
- mixed #2: **three P1 completion routes, none ready**. (1) Bopp & Gottsberger 2004 (*Silene × Hadena*) directly measures same-season flowering and moth oviposition but lacks a final plant reproductive surface in the article; Bopp 2003 is the completion target. (2) Kawashima et al. 2026 (*Sambucus × Heterhelus*) has direct beetle observations and final inflorescence-level fruit/seed fate, but the visitor records are not yet linked to each reproductive unit's flowering window. (3) Rentería & Cantú 2003 (*Yucca filifera × Tegeticula yuccasella*) directly measures the same-season moth window and mature viable/damaged seeds, but final seed records are pooled across flowering cohorts, so the March-high versus May-zero-moth contrast cannot yet be linked to final reproduction. All three remain fail-closed until the missing within-programme linkage/surface is recovered;
