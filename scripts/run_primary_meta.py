...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run IWE first-release reference meta summaries.")
    ...
    summary = fixed_effect_summary(primary)
    ...
    print(f"Wrote reference outputs to {outdir}. These are software/reference summaries, not publication-model results.")
    return 0
